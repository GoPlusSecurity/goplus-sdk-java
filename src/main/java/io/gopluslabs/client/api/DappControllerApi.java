...
public class DappControllerApi {
     ...
     */
    public okhttp3.Call getDappInfoUsingGETCall(String authorization, String url, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private okhttp3.Call getDappInfoUsingGETValidateBeforeCall(String authorization, String url, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {

        okhttp3.Call call = getDappInfoUsingGETCall(authorization, url, progressListener, progressRequestListener);
        return call;
    ...
    public ApiResponse<ResponseWrapperDappContractSecurityResponse> getDappInfoUsingGETWithHttpInfo(String authorization, String url) throws ApiException {
        okhttp3.Call call = getDappInfoUsingGETValidateBeforeCall(authorization, url, null, null);
     ...
     */
    public okhttp3.Call getDappInfoUsingGETAsync(String authorization, String url, final ApiCallback<ResponseWrapperDappContractSecurityResponse> callback) throws ApiException {
        ...
        okhttp3.Call call = getDappInfoUsingGETValidateBeforeCall(authorization, url, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ResponseWrapperDappContractSecurityResponse>(){}.getType();
